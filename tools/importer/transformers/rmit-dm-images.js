...
/**
 * Transformer: RMIT Dynamic Media / Scene7 images.
 *
 * The source uses Scene7 IS/Image URLs (e.g.
 * https://s7ap1.scene7.com/is/image/rmit/gbs-2026-r-1220x732?wid=800 —
 * found in migration-work/metadata.json .images.mapping). This transformer
 ...
 * <img> references into block cells (cards/carousel/columns), so rewriting imgs
 * to anchors earlier would leave parsers with empty image cells.
 *
 * Helpers below are the canonical subset the transformer consumes, copied
 * byte-identical from references/dm-scene7-helpers.js (detectDynamicMediaUrl,
